...
def manually_fill():
    ...
    def fill_attendance():
        ...
        try:
            ...
            connection = pymysql.connectconnection = pymysql.connect(
    host="localhost",
    user="root",                # Replace 'root' with your MySQL username
    password="babbu",  # Replace with your MySQL password
    database="db"   # Name of the database to connect to
        ...
        if subb == '':
            ...
            def create_csv():
                ...
                csv_name = 'C:/Users/Manihas/PycharmProjects/Attendace_management_system/Attendance/Manually Attendance/'+DB_table_name+'.csv'
    ...
    def log_in():
        ...
        if username == 'root':
            if password == 'root':
                ...
                cs = 'C:/Users/Manihas/P2-Attendance-Management-System-using-Face-Recognition/StudentDetails/StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
